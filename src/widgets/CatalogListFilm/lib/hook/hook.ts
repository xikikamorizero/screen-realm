...
export const useFilter = () => {
    ...
    return {
        genreArrayData: store.genresArrayData,
        countriesArrayData: store.countriesArrayData,
        store: store,
    };
};
